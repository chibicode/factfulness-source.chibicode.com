...
export default () => (
  <>
    ...
    <p>
      ...
      。Elsevier
      Publishingは2015年に40万の査読付き論文を出している。これには世界780万人の科学者コミュニティーのうち70万人が関わった。
    </p>
    <p>
      世界初の査読付き科学ジャーナルはthe Royal Society in
      LondonによるPhilosophical
      Transactions。第一号は1665年3月に公開され、1年間に119本の科学論文が掲載された。この数は書評などを除き、現在の科学論文と似たような形式の記事だけを数えたもの。ちなみに同じ年にフランスでJournal
