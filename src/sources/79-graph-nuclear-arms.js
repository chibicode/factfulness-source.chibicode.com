  ...
  <>
    ...
    <H.BlockAddition>
      <p>
        ...
        グラフでは核兵器の数は最高が「64」、最低が「15」(単位は千発)とされており、「6万4000」「1万5000」とは書かれていない。これは、核兵器の数を恣意的に小さく見せているのではない。ほかのグラフでも、グラフの最大値と最小値に共通する単位で割った数字を表示しているから、核兵器の数もそれと合わせているだけだ。たとえば
