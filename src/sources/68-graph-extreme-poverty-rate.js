...
export default () => (
  <>
    ...
    <p>
      van
      Zanden[1]は、Maddison[1]による過去のひとりあたりGDPを用いて、人々の所得を算出している。所得分布を調べる際には、人々の身長の分布に注目した(これには軍の資料をあたった)。子供の頃に食べ物が足りないと、大人になっても身長が低いままだ。このように身長に注目することによって、食糧不足、すなわち極度の貧困にある人口の割合を算出した。この調査によると、1820年に1日2ドル以下(
      <H.OtherCardLink permalink="ppp-extreme-poverty">
        購買力平価
      </H.OtherCardLink>
      をもとに調整、1990年国際ドル)で暮らしていた人の割合は73%、1ドル以下の割合は39%だった。
    </p>
    <p>
