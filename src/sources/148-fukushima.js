  ...
  <>
    ...
    <H.BlockAddition>
      <p>
        ...
        」(2012年3月31日までに把握できた数)。この資料によると、震災関連死の死者は1632人で、「東日本大震災による負傷の悪化等により亡くなられた方で、災害弔慰金の支給等に関する法律に基づき、当該災害弔慰金の支給対象となった方」と定義されている。
      </p>
    </H.BlockAddition>
    <p>
    ...
    <H.BlockAddition>
      <p>
        <H.BlockAdditionHeader />
        2018年9月には、原発作業員の死亡者のひとりが「被ばくによる死亡」として労災認定された。ただし、医学的な論文が発表されたわけでもなく、あくまで労災が認定されたということだ。これは厚生省の発表で、
        <H.A href="https://www.nikkei.com/article/DGXMZO34966870U8A900C1CR8000/">
          日経新聞
        </H.A>
        、
        <H.A href="https://mainichi.jp/articles/20180905/k00/00m/040/105000c">
          毎日新聞
        </H.A>
        、
        <H.A href="https://www.asahi.com/articles/ASL9524MNL95UBQU001.html">
          朝日新聞
        </H.A>
        、
        <H.A href="https://www.yomiuri.co.jp/science/20180904-OYT1T50064/">
          読売新聞
        </H.A>
        が報じた。
      </p>
