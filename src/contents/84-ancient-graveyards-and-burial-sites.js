...
export default () => (
  <>
    ...
    <H.InlineCitation>
      <ul>
        <li>
          Lewis (2006) Mary E. Lewis The Bioarchaeology of Children:
          Perspectives from Biological and Forensic Anthropology "2- Fragile
          bones and shallow graves." Cambridge U P. See p. 20 and Table 2.1.
          DOI: 10.1017/CBO9780511542473.002
        </li>
        <li>
          <H.A href="https://www.sciencedirect.com/science/article/pii/S0018442X15000748">
            Manifold (2014) "Skeletal preservation of children's remains in the
            archaeological record." HOMO-Journal of Comparative Human Biology 66
            6: pp. 520-548.
          </H.A>
