...
export default () => (
  <>
    <p>
      <H.FB pageNumber={364}>
        1948年に、パウル・ヘルマン・ミュラーは「多数の節足動物に対するDDTの接触毒としての強力な作用の発見」が評価されてノーベル生理学・医学賞を受賞した。DDTを世界で初めて禁止したのはハンガリー(1968年)。それに続いたのはスウェーデンだった(1969年)。アメリカはその3年後にDDTを禁止した(
        <H.A href="https://www.cdc.gov/biomonitoring/ddt_biomonitoringsummary.html">
          CDC[2]
        </H.A>
        )。その後、
      </H.FB>
