...
export default () => (
  <p>
    ...
    government around Kikwit in 1995 and enforced through military roadblocks.
    But contacts under fever surveillance travelled outside the cordon in dugout
    canoes. The military patrolled roads, but not forest paths leading to the
    Kwilu River.&quot;
  </p>
)
