...
export default () => (
  <p>
    In the passage about the most common fears, we refer to those self-reported
    among adults. The polls, conducted in the United States and the United
    Kingdom respectively, reported similar results. In the Gallup[2] survey, top
    US fears were snakes; public speaking; and heights, followed by entrapment;
