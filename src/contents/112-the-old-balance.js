...
export default () => (
  <>
    <p>
      Gapminder presents the old balance as a family with 6 children, out of
      which 4 die. This iconic family represents a theoretical average, measured
      over the millennia with wide ranges in mortality and fertility. In the
      long time-frame, however, the average family probably had no more than two
      surviving children, since population growth on average stayed stable until
      1800.
    </p>
    <p>
    ...
    <p>
      ...
      caused by famines, wars or pandemics, killed many and became much more
      common with agriculture and crowded settlements, or through contact with
      other populations that brought germs with them. For regular years, between
      these bad periods, estimates vary from 32% to 45% of deaths in children
      under-5 years, which is a similar rate to that of the hunter-gatherer
    ...
    <p>
      ...
      diseases from domesticated animals killed many, child mortality in regular
      years was probably above 35%. The main sources behind our assumptions
      about fertility and mortality in pre-1800 families are Livi-Bacci (1989),
      Paine and Boldsen (2002), and Gurven and Kaplan (2007).
    </p>
  </>
)
