...
export default () => (
  <>
    ...
    <p>
      ...
      percent of the world population are still in the "developing" box. Those
      are as follows: Angola, Burkina Faso, Burundi, Chad, DR Congo, East Timor,
      Gambia, Mali, Mozambique, Niger, Nigeria, Somalia and Uganda. 37 countries
      with 8.4% of the world population are between the boxes. 134 countries are
      in the "developed" box. For an interactive version of the chart, see{' '}
      <H.A href="http://gapm.io/voutdwv">gapm.io/voutdwv</H.A>.
    </p>
  </>
)
