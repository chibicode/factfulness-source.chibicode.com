...
export default () => (
  <p>
    ...
    in 2008 (<H.A href="http://gapm.io/xobewar08">www.gapm.io/xobewar08</H.A>)
    that the number of battle deaths in recent wars seems much higher if
    ...
    <H.A href="http://www.gapm.io/xgledwar12">www.gapm.io/xgledwar12</H.A>),
    making the case that their data-sources are indeed bias in an unknown way
    and that the bias may not be the same over the decades. Maybe the tendency
    is to under-report in some wars in some decade and then over-report in
    others. But still, even if they take into account the experts highest levels
    of doubts and use the widest reasonable uncertainty estimates and they try
    their hardest to generate an increasing impression of fatalities, by drawing
    a trendline from the lowest estimates of past conflicts to the highest
