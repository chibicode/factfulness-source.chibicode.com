...
export default () => (
  <>
    ...
    <p>
      ...
      comes from previous editions of the ITU report via World Bank[19]. These
      are combined in <H.A href="http://gapm.io/dintus">Gapminder[22]</H.A>. The
      first data point, zero internet users in 1980, is based on the Internet
      System Consortium (ISC), which count internet hosts historically. The
