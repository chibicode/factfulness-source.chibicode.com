...
export default () => (
  <>
    <p>
      ...
      &quot;total fertility rate&quot; (TFR). Fertility rates decline during
      times of hardship. The dips and humps before 1965 shown on the graph were
      caused by the Second World War and famines. Fertility climbs to rates
      higher than usual when the crisis is over. Globally, the average fertility
      rate was at 5.05 children in 1950, according to UN-Pop[3]. As of 2017, the
      estimated fertility rate was 2.48 children, according to UN-Pop.
      Replacement rate with the current mortality worldwide is 2.3.
    </p>
    <p>
