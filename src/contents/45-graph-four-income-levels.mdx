The numbers are rounded to billion people to make it easier to remember. Incomes are in price adjusted PPP 2011 dollars by ICP. [Gapminder[8]](http://gapm.io/incm) estimates that the number of people on each income level in 2017 are as follows:
...
The detailed estimates are based on the World Bank's PovcalNet for 2013 and forecasts from [IMF[1]](http://gapm.io/ximfw). [Povcal[1]](http://iresearch.worldbank.org/PovcalNet) is the dataset that the World Bank uses to estimate the official rate of extreme poverty worldwide. Data was collected through household income surveys from across the world. National currencies are converted to comparable dollars adjusted for differences between countries in cost of living. The threshold of $2 per day is almost identical to the World Bank's $1.9 per day. Gapminder rounded that up to $2 per day to make it easier to remember, and to avoid the false precision in poverty estimates that are very rough. See [www.gapm.io/fwlevels](http://www.gapm.io/fwlevels)