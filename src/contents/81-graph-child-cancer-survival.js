...
export default () => (
  <p>
    ...
    elsewhere. That's what we mean by "best treatment". The trend shows that
    cancer research has been successful and the state of the art treatment is
    improving, but we should keep in mind that most people don't have access to
    this treatment. The first part of the trend line comes from NCI[1] (National
